...
export function EditarCancionForm({ cancion }: { cancion: Cancion }) {
  ...
  const [formData, setFormData] = useState({
    ...
    libro: cancion.libro || 'Cancionero IPUC',
    tonalidad: cancion.tonalidad || '',
    tempo: cancion.tempo || 'Medio',
    letra: cancion.letra || '',
  })

  // Ajusta esta variable según el nombre exacto de tu carpeta en app/
  // Si tu carpeta es app/canciones/[id], usa '/canciones/'
  // Si tu carpeta es app/[id], usa '/'
